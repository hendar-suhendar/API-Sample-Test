...
def response = WS.sendRequestAndVerify(findTestObject('Object Repository/Gorest/Update User/TC1_Negative_Update User Data'))
...
println jsonString
WS.verifyEqual(jsonString, '{"message":"Resource not found"}')
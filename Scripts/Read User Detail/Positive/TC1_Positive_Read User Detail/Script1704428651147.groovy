...
def response = WS.sendRequestAndVerify(findTestObject('Object Repository/Gorest/Read User Detail/TC1_Positive_Read User Detail'))
...
WS.verifyElementPropertyValue(response, 'id', '5892652')
WS.verifyElementPropertyValue(response, 'name', 'ibnu musa')
WS.verifyElementPropertyValue(response, 'gender', 'male')
WS.verifyElementPropertyValue(response, 'email', 'ibnu@mail.com')
